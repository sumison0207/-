...
function postToSlack() {
 var sheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName(' '); //←タブのシート名
 
//指定したセルの値を取得。
 var value1 = sheet.getSheetValues(3, 3, 1, 1);  //slackメンバーIDのあるセルを指定
